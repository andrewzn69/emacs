...
(defvar my/modules '(ui modeline dashboard editor project pdf evil tools/treeshitter lang completion/corfu completion/orderless completion/vertico org git))
