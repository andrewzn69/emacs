...
(let (;; nvim colorscheme colors with the crimson backgrounds, grays and diff colors
	...
	(custom-theme-set-faces
	 ...
	 `(my/org-priority-a ((t :foreground ,bg0 :background ,red :distant-foreground ,red :weight semibold)))
	 `(my/org-priority-b ((t :foreground ,bg0 :background ,yellow :distant-foreground ,yellow :weight semibold)))
	 `(my/org-priority-c ((t :foreground ,bg0 :background ,gray :distant-foreground ,gray :weight semibold)))
